...
class text2vec():
    ...
    def _keep_token(self, t):
        return (
            t.is_alpha and not (
                t.is_space or t.is_punct or t.is_stop or t.like_num
            )
        )
    ...
    def _get_docs_dict(self, docs):
        ...
        # CAREFUL: For small corpus carefully modify the parameters for filter_extremes, or simply comment it out.
